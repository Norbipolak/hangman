...
class Hangman {
    ...
    errors; //egy string tömb, tömb, amikben stringek lesznek 
    guessed; //azokat a karaktereket fogja tartalmazni, amiket már kitaláltunk 
    words; //ebből a tömbböl fogunk kiválogatni szavakat 
    word; //a szó, amit majd ki kell találni 
    constructor() {
